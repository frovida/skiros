#ifndef CUSTOM_DIALOG_WINDOW_H
#define CUSTOM_DIALOG_WINDOW_H
...
Q_DECLARE_METATYPE(visualization_msgs::InteractiveMarkerFeedbackConstPtr);
...
public:     //## METHODS:
  ...
  //Skiros functions
  void initSkirosInterfaces(boost::shared_ptr<skiros_wm::WorldModelInterface> wm_ptr, boost::shared_ptr<interactive_markers::InteractiveMarkerServer> interactive_m_server)
  {
      wm_ptr_=wm_ptr;
  ...
  int addSkirosTypeComboBox(QString tooltip="");
  //Skiros functions end
...
private:
  ...
  QComboBox * individual_combo_box_;
  QComboBox * type_combo_box_;
  QComboBox * prop_combo_box_;
...
public slots:   //## SLOTS:
  ...
  void skirosPropertyCbIndexChanged(int index);
  void skirosTypeCbIndexChanged(int index);
  void skirosIndividualCbIndexChanged(int index);
  void interactiveMarkerFeedbackProcess(const visualization_msgs::InteractiveMarkerFeedbackConstPtr &feedback);
